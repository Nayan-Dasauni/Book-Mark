    ...
    bookmarks
      .filter(
        (b) =>
          ...
          b.tags.join(',').toLowerCase().includes(filter.toLowerCase())
      )
      .forEach((bookmark, index) => {
        ...
        div.querySelector('.edit-btn').addEventListener('click', () => editBookmark(index));
        div.querySelector('.delete-btn').addEventListener('click', () => deleteBookmark(index));
